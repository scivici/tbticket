    ...
    <div className="space-y-16">
      ...
      <section className="text-center py-12">
        ...
        <div className="flex justify-center gap-4">
          ...
          <Link to="/track" className="inline-flex items-center px-6 py-3 bg-tb-card text-gray-200 border border-gray-600 rounded-lg font-medium hover:bg-gray-600 transition-colors">
      ...
      <section className="grid md:grid-cols-3 gap-8">
        ...
        <div className="tb-card p-6">
          ...
          <h3 className="text-lg font-semibold text-white mb-2">Smart Assignment</h3>
          <p className="text-gray-400 text-sm">
      ...
      {/* Products */}
      <section>
        <h2 className="text-2xl font-bold text-center text-white mb-8">Supported Products</h2>
        <div className="grid md:grid-cols-3 gap-5 max-w-5xl mx-auto">
          <div className="tb-card p-5">
            <div className="text-2xl mb-2">📡</div>
            <h3 className="text-base font-semibold text-white mb-1">ProSBC / FreeSBC</h3>
            <p className="text-gray-400 text-xs">Carrier-grade Session Border Controllers for SIP trunking, peering, and security.</p>
          </div>
          <div className="tb-card p-5">
            <div className="text-2xl mb-2">🔌</div>
            <h3 className="text-base font-semibold text-white mb-1">Tmedia Gateways</h3>
            <p className="text-gray-400 text-xs">TMG800, TMG3200, TMG7800 VoIP/SS7 media gateways for TDM-to-IP migration.</p>
          </div>
          <div className="tb-card p-5">
            <div className="text-2xl mb-2">🔗</div>
            <h3 className="text-base font-semibold text-white mb-1">Tsig Gateways</h3>
            <p className="text-gray-400 text-xs">TSG800, TSG3200 SS7/SIGTRAN signaling gateways with 99.999% availability.</p>
          </div>
        </div>
      </section>
    </div>
