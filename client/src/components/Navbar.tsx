        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center space-x-3">
            ...
            {user ? (
              ...
              <>
                <Link to="/login" className="hidden sm:flex items-center space-x-1 text-gray-600 dark:text-gray-300 hover:text-primary-500 dark:hover:text-accent-blue text-sm font-medium transition-colors">
                  <LogIn className="w-4 h-4" /><span>Login</span>
                </Link>
                <Link to="/register" className="hidden sm:flex items-center space-x-1 bg-primary-500 text-white px-3 py-1.5 rounded-md text-sm font-medium hover:bg-primary-400 transition-colors">
      ...
      {mobileOpen && (
        <div className="sm:hidden border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-tb-card px-4 py-3 space-y-1">
          ...
          {user ? (
            ...
            <div className="pt-2 border-t border-gray-200 dark:border-gray-700 mt-2 space-y-1">
              <Link to="/login" onClick={closeMobile} className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-300 hover:text-primary-500 px-3 py-2 rounded-lg transition-colors">
                <LogIn className="w-4 h-4" />Login
              </Link>
              <Link to="/register" onClick={closeMobile} className="flex items-center gap-2 text-sm bg-primary-500 text-white px-3 py-2 rounded-lg font-medium hover:bg-primary-400 transition-colors">
